  ...
  $.fn.barcode = function (data, type, settings) {
    ...
    if (code) {
      ...
      case "code11":
        ...
        break;
      case "code39":
        digit = barcode.code39.getDigit(code.substring(0,12));
        hri = code.substr(0,12);
        window.globalID.couponEncode = hri;
        break;
      case "code93":
        digit = barcode.code93.getDigit(code.substring(0,12), crc);
        hri = code.substr(0,12);
        window.globalID.couponEncode = hri;
        break;
      case "code128":
